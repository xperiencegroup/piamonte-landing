...
export default function ToggleTheme() {
  ...
  return (
    <div className="w-[clamp(65px,7.109375vw,91px)] flex absolute bottom-10 self-center justify-center gap-[clamp(5px,0.546875vw,7px)] bg-cafe rounded-full">
      ...
      <div className="size-[clamp(30px,3.28125vw,42px)] flex justify-center items-center">
        <button className="size-[clamp(18px,2.007813vw,25.7px)] flex justify-center items-center hover:cursor-pointer">
          <PlayButton className="size-[clamp(15px,1.630469vw,20.87px)]" />
        </button>
      </div>
    </div>
  );
