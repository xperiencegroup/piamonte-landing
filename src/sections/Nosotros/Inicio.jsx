  ...
  return (
    <div className="w-full h-dvh lg:pb-[clamp(31px,5.46875vw,70px)]">
      <div className="flex flex-col w-full h-full justify-end items-center max-sm:px-7 sm:px-10 md:px-12 lg:pb-[clamp(10px,1.796875vw,23px)]">
        <div className="flex h-full justify-center items-center gap-[clamp(18px,3.125vw,40px)] pt-[clamp(40px,7.03125vw,90px)]">
          {/* Image */}
          <img
            src={letterImage}
          ...
          <div className="relative flex justify-center items-center w-full max-w-[752px] h-[clamp(146px,25.625vw,328px)]">
            {/* Container Background Image */}
            <img
              src={PaperBody}
              alt="Imagen de hoja"
              className="absolute -z-10 w-full h-full inset-0 object-contain"
            />
