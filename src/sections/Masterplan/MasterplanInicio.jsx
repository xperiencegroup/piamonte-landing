  ...
  return (
    <>
      ...
      <div className="relative w-full h-dvh flex justify-center items-center">
        <div className="flex justify-center items-end w-[clamp(540px,95vw,1216px)] h-[clamp(308px,54.140625vw,693px)] gap-[clamp(11px,1.875vw,24px)]">
          <Link
            to="/masterplan/amenidades"
            className="flex w-fit justify-center items-center gap-[clamp(4px,0.78125vw,10px)] p-[clamp(7px,1.25vw,16px)] border-b border-gris dark:border-nude"
          >
