...
export default function LoteLayout() {
  ...
  return (
    <div className="flex flex-col h-dvh w-full">
      {/* Fake navbar */}
      <div className="shrink-0 h-[clamp(38px,6vw,75px)]" />
            ...
            {LOTE_MENU.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {/* TEXT */}
                  <span
                    className={`text-boton-normal uppercase whitespace-nowrap ${isActive(item.to) && item.type !== "return" ? "text-cafe dark:text-amarillo font-semibold" : "text-gris dark:text-nude"}`}
                  >
                    {item.label}
                  </span>
                </Link>
