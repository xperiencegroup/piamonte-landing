        ...
        <div className="relative w-[clamp(478px,84.0625vw,1076px)] h-[clamp(176px,31.015625vw,397px)]">
          ...
          <div className="relative flex flex-col w-full h-full justify-center items-center gap-[clamp(7px,1.25vw,16px)]">
            ...
            <p className="w-[clamp(355px,62.5vw,800px)] text-paragraph text-center leading-[120%] text-cafe">
              ...
              Es despertar con calma, respirar profundo y permitir que la
              naturaleza marque el compás de tus días.
              <br />
              <br />
              En <span className="font-bold">Piamonte Residencial</span>,
              creamos un entorno donde el bienestar no es un concepto, sino una
